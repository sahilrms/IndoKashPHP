...
$items_query = $conn->query("SELECT * FROM quality_control");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $delete_stmt = $conn->prepare("DELETE FROM quality_control");
    $delete_stmt->execute();
    $target_dir = "../img/quality_control_images/";
    ...
    foreach ($_FILES['items']['tmp_name'] as $index => $tmp_name) {
        ...
        if (isset($tmp_name['image']) && is_uploaded_file($tmp_name['image'])) {
            ...
            if (move_uploaded_file($tmp_name['image'], $target_file)) {
                ...
                $insert_stmt = $conn->prepare("INSERT INTO quality_control (image_link, title, description) VALUES (?, ?, ?)");
                $insert_stmt->bind_param("sss", $target_file, $title, $description);
                $insert_stmt->execute();
            } else {
...
<h1 class="bg-white flex justify-center text-2xl font-bold px-2 py-4">Add Quality Control</h1>
                ...
                <div class="border rounded-lg shadow-2xl bg-white w-5/6 mx-auto flex flex-col space-y-1 my-2 p-4">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-2/5 mx-auto flex flex-col">
                            <label for="title_<?php echo $index ?>" class="text-gray-600">Title:</label>
                    ...
                    <textarea id="description_<?php echo $index ?>" name="items[<?php echo $index ?>][description]" required
  ...
  <path fill-rule="evenodd" d="M10 11.414l4.293 4.293a1 1 0 0 0 1.414-1.414L11.414 10l4.293-4.293a1 1 0 0 0-1.414-1.414L10 8.586 5.707 4.293a1 1 0 0 0-1.414 1.414L8.586 10l-4.293 4.293a1 1 0 1 0 1.414 1.414L10 11.414z" clip-rule="evenodd"></path>
            ...
            <div class="flex flex-wrap">   
                    ...
                    <div class="w-2/5 mx-auto flex flex-col">
                        <label for="title_${itemCount}" class="text-gray-600">Title:</label>
